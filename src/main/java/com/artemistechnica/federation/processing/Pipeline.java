...
public class Pipeline {
    ...
    public static <A, B> Function<A, EitherE<B>> pipeline(Function<A, B> mapFn, Function<A, EitherE<A>>... steps) {
        return (A ctx) -> {
...
//        }
        ...
        public static <A> Function<A, EitherE<A>> step(Function<A, EitherE<A>> fn) {
            return (A ctx) -> fn.apply(ctx);//EitherE.failure(SimpleError.create("Method not implemented"));
        }
    }
